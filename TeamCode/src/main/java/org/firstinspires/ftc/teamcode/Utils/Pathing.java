...
public class Pathing {
    ...
    static double[] current = Pinpoint.getPosition(); // idk why the f*ck dos this use "roundList" and why dos "roundList" even exist. if end is not rounded it will go on with the loop forever (current != end) and it just makes it less accurate. >:(
